...
Config.PhoneItem = {"phone","iphone", "blue_phone", "white_phone", "yellow_phone", "pink_phone", "red_phone", "green_phone"} -- Phone item spawn name, can be a table: {"phone1", "phone2"}
...
Config.JobContacts = {
    ["police"] = { -- People with this job will receive these calls/messages.
        ...
        preAdded = false, -- Add it to the contacts app or not? If not added [set to false], you can only call it through the phone app, or message it through the messages app.
        callable = false, -- Can you call the contact?
