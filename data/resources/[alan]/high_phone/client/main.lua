...
RegisterNUICallback("updateVehicles", function(_, cb)
    QBCore.Functions.TriggerCallback("high_phone:getVehicles", function(vehicles)
        local data = {}
        for k, v in pairs(vehicles) do
...
function L11_1()
    ...
    L0_2 = isOpen
    if not L0_2 then
         QBCore.Functions.TriggerCallback('high_phone:getPhoneItem', function(itemName)
        local frame = "frame.png" --bos frame

        if itemName == "yellow_phone" then
            frame = "yellowframe.png"
        elseif itemName == "blue_phone" then
            frame = "blueframe.png"
        elseif itemName == "white_phone" then
            frame = "whiteframe.png"
            elseif itemName == "pink_phone" then
            frame = "pinkframe.png"
             elseif itemName == "iphone" then
            frame = "iphone16frame.png"
            elseif itemName == "red_phone" then
            frame = "redframe.png"
            elseif itemName == "green_phone" then
            frame = "greenframe.png"
        end
...
RegisterCommand("denetelefon", function()
