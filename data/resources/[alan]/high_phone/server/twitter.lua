  ...
  function L9_2(A0_3)
    ...
    if A0_3 then
      ...
      if A0_3 == L1_3 then
        ...
        L1_3 = L1_3.Sync
        L1_3 = L1_3.fetchAll
        L2_3 = "SELECT `nickname`, `picture`, `rank` FROM phone_twitteraccounts WHERE `email` = @email"
        L3_3 = {}
        L4_3 = L5_2
        L3_3["@email"] = L4_3
        L1_3 = L1_3(L2_3, L3_3)
...
function L7_1(A0_2)
  ...
  function L7_2(A0_3)
    ...
    if nil ~= A0_3 then
      ...
      L9_3 = L9_3[L10_3]
      L8_3.resetCode = L9_3
      L6_3 = string.gsub(L7_3, "{resetCode}", L8_3.resetCode)
      L7_3 = {}
...
Config.FrameworkFunctions.registerCallback("high_phone:getTweets", function(_ARG_0_, _ARG_1_)
  local data = {}
  data.userData = getTwitterUser(Config.FrameworkFunctions.getPlayer(_ARG_0_).identifier)
  data.tweets = L0_1
  _ARG_1_(data)
end)
