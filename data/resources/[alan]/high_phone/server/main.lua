...
QBCore.Functions.CreateUseableItem("yellow_phone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "yellow_phone")
end)

QBCore.Functions.CreateUseableItem("iphone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "iphone")
end)

QBCore.Functions.CreateUseableItem("blue_phone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "blue_phone")
end)

QBCore.Functions.CreateUseableItem("white_phone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "white_phone")
end)

QBCore.Functions.CreateUseableItem("pink_phone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "pink_phone")
end)


QBCore.Functions.CreateUseableItem("red_phone", function(source, item)
    TriggerClientEvent("high_phone:openPhone", source, "pink_phone")
end)
...
QBCore.Functions.CreateCallback('high_phone:getPhoneItem', function(source, cb)
    ...
    for _, item in pairs(xPlayer.PlayerData.items) do
        if item and item.name then
            if item.name == "yellow_phone" or item.name == "blue_phone" or item.name == "white_phone" or item.name == "pink_phone" or item.name == "iphone" or item.name == "red_phone" or item.name == "green_phone" then
                phoneItem = item.name
                break
            end
        end
