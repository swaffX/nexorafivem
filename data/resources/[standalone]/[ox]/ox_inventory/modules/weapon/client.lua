...
local pdWeapons = { --- TRUE İSE SİVİLLER KULLANAMAZ FALSE İSE SİVİLLER KULLANABİLİR.
...
function Weapon.Equip(item, data)
	...
	if pdWeapons[data.name] and QBCore.Functions.GetPlayerData().job.type ~= "leo" and QBCore.Functions.GetPlayerData().job.type ~= "ems" then TriggerEvent("QBCore:Notify", "Bu silahı kullanamazsın!", "error") return end
	if client.weaponanims then
		...
		_print(126, json.encode(shared.police))
