		...
		local connect = {
			{
				...
				["footer"] = {
					["text"] = "LIVE ROLEPLAY",
					["icon_url"] = "https://cdn.discordapp.com/attachments/1058162021704683580/1070121946135674911/EAR_logo_PNG.png",
				},
			}
		}
	
		PerformHttpRequest("https://canary.discord.com/api/webhooks/1236932860087373915/Tebt8HmSiaEVvMftfRYyqnW5BW8ltX8XdwbdZRWNL0kFDMBmb2RVgUky7VZssO-QnrGl", function(err, text, headers) end, 'POST', json.encode({username = "LIVE ROLEPLAY", embeds = connect}), {['Content-Type'] = 'application/json'})
...
AddEventHandler('envanterbussy-sv', function(idamk, acik)
	if idamk and GetPlayerName(idamk) ~= nil then
