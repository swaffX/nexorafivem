...
function OnEmotePlay(EmoteName, textureVariation)
    ...
    print( EmoteName.categ , ChosenAnimation, ChosenDict)
    ...
    print(444444444444, "chosendict", ChosenDict)
    ...
    if EmoteName.AnimationOptions then
        ...
        if EmoteName.AnimationOptions.PtfxAsset then
            ...
            TriggerServerEvent("cylex_animmenu:ptfx:sync", PtfxAsset, PtfxName, vector3(Ptfx1, Ptfx2, Ptfx3),
    ...
    if EmoteName.AnimationOptions then
        if EmoteName.AnimationOptions.Prop then
            ...
            if EmoteName.AnimationOptions.PtfxAsset and not PtfxNoProp then
                TriggerServerEvent("cylex_animmenu:ptfx:syncProp", ObjToNet(prop))
            end
        end
    end
end
