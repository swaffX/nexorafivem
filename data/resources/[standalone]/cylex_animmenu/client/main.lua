CreateThread(function()
    ...
    RegisterNetEvent('cylex_animmenu:client:openMenu', function()
        openMenu(true)
    end)
    ...
    RegisterKeyMapping('emotemenu', 'Animasyon menüsünü açar', 'keyboard', 'F5')
    ...
    RegisterNUICallback("callShared", function(data, cb)
        ...
        if (distance ~= -1 and distance < 3) then
            ...
            print("ServerEmoteRequest: " .. GetPlayerServerId(target) .. " " .. anim)
