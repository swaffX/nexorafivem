...
Config.ShowDebug = true -- If you set this to `true`, the debug messages will be printed in the console. If you set it to `false`, no debug messages will be printed.
