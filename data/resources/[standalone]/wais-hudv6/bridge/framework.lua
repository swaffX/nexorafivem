...
function wFramework.requestData()
    ...
    elseif Config.Framework.Framework == "qbcore" then
        ...
        local success, result = pcall(function()
            -- New QBCore: GetPlayerData() returns data directly, no callback needed
            local data = wFramework.Framework.Functions.GetPlayerData()
            return data
        end)
...
function wFramework.GetPlayerMoney()
    ...
    elseif Config.Framework.Framework == "qbcore" then
        if Config.MoneySettings.isItem then
            ...
            if wFramework.Framework.PlayerData and wFramework.Framework.PlayerData.items then
            ...
            if wFramework.Framework.PlayerData and wFramework.Framework.PlayerData.money then
...
function wFramework.GetPlayerBank()
    ...
    if Config.Framework.Framework == "esx" then
        ...
        if wFramework.Framework.PlayerData and wFramework.Framework.PlayerData.accounts then
            for _, account in pairs(wFramework.Framework.PlayerData.accounts) do
