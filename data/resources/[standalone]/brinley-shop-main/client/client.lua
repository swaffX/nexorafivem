    ...
    for k, v in pairs(Config.Shops) do
        for a, b in pairs(v.coords) do
            if Config.Text == 'textui2' then           
                ...
                exports['brinley-textui-2']:create3DTextUI("brinley-shop-" .. id, {
                    coords = coords,
                    displayDist = 5.0,
                    interactDist = 2.0,
                    enableKeyClick = true,
                    ...
                    job = reqJob,
                    triggerData = {
                        triggerName = "brinley-shop:openShop",
                ...
                for a, b in pairs(v.coords) do
                    ...
                    if dist <= 3 then
                        if Config.Text == 'textui1' then 
                            ...
                            exports["brinley-text"]:openTextUi(item,b.coords,3)
    ...
    for k, v in pairs(Config.Shops) do
        ...
        for a, b in pairs(v.coords) do
            ...
            if Config.UseTextUI == false then
                ...
                -- exports['brinley-textui']:AddTextUIPed(ObjToNet(b.ped), vector3(b.coords.x, b.coords.y, b.coords.z), 'E', 'Open Shop', 2.5)
            end
        end
    end
end
...
RegisterNUICallback("pay",function(data)
    TriggerServerEvent("brinley-shop:pay", data)
end)
...
RegisterNetEvent('brinley-shop:openShop')
AddEventHandler('brinley-shop:openShop', function(data)
...
RegisterNUICallback('makePayment', function(data)
    TriggerServerEvent('brinley-shop:makePayment', data.type, data.price, basket)
end)

RegisterNUICallback('makePaymentJob', function(data)
    TriggerServerEvent('brinley-shop:makePayment', data.type, data.price, basketJob)
end)
