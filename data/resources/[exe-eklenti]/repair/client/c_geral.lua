...
local BlacklistVehicles = { -- Used from qb-vehicle failure <3
'ninef',
'adder',
'vagner',
't20',
...
RegisterNetEvent('m-Repairs:client:Falar')
AddEventHandler("m-Repairs:client:Falar", function()
    local playerPed = GetPlayerPed(-1)
    local vehicle   = GetVehiclePedIsIn(playerPed, false)
