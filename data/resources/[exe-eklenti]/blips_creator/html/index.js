...
function addBlip(blipId, blipData, canBeEdited){
    ...
    var blipDiv = $(`
        <div class="blip col border rounded m-2">
            ${blipData.isHidden && '<i class="blip-toggle bi bi-eye-slash float-end fs-3"></i>' || '<i class="blip-toggle bi bi-eye float-end fs-3"></i>'}
            <p class="blip-name text-center fs-2 fw-bold mt-3">${blipData.name}</p>
