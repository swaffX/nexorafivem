...
RP.Shared = {
    ...
    ["sitchrlv2f"] = {
        "benchf@spider",
        "benchf_clip",
        "Ateşli Sandalyeye Oturma Pozu 2 💕",
        "sitchrlv2m",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex"] = {
        ...
        "missionarym",
        "Sırt Üstü Uzan Ve Bacaklarını Aç 🔞",
        "sex2",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex9"] = {
        ...
        "cowgirlm",
        "Karşındakini Sırt Üstü Yatır Ve Üstüne Çık 🔞",
        "sex10",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex10"] = {
        ...
        "cowgirlf",
        "Sırt Üstü Uzan Ve Kucağında Hoplat 🔞",
        "sex9",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["sex16"] = {
        ...
        "standingf",
        "Karşı Tarafı Domalt Ve Ellerini Duvara Yasla 🔞",
        "sex15",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
...
RP.Dances = {
    ...
    ["idans"] = {"divined@dances@new", "ddance13", "İlahi Dans", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans2"] = {"divined@dances@new", "ddance1", "İlahi Dans 2", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans3"] = {"divined@dances@new", "ddance3", "İlahi Dans 3", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans4"] = {"divined@dances@new", "ddance4", "İlahi Dans 4", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans5"] = {"divined@dances@new", "ddance5", "İlahi Dans 5", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans6"] = {"divined@dances@new", "ddance6", "İlahi Dans 6", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans7"] = {"divined@dances@new", "ddance7", "İlahi Dans 7", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans8"] = {"divined@dances@new", "ddance8", "İlahi Dans 8", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans9"] = {"divined@dances@new", "ddance9", "İlahi Dans 9", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans10"] = {"divined@dances@new", "ddance10", "İlahi Dans 10", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans11"] = {"divined@dances@new", "ddance11", "İlahi Dans 11", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["idans12"] = {"divined@dances@new", "ddance12", "İlahi Dans 12", AnimationOptions =
    {
       EmoteLoop = true
    }},
    -- Version Two
    ["gdans"] = {"divined@dancesv2@new", "divdance1", "Gösteriş Dansı", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans2"] = {"divined@dancesv2@new", "divdance2", "Gösteriş Dansı 2", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans3"] = {"divined@dancesv2@new", "divdance3", "Gösteriş Dansı 3", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans4"] = {"divined@dancesv2@new", "divdance4", "Gösteriş Dansı 4", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans5"] = {"divined@dancesv2@new", "divdance5", "Gösteriş Dansı 5", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans6"] = {"divined@dancesv2@new", "divdance6", "Gösteriş Dansı 6", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans7"] = {"divined@dancesv2@new", "divdance7", "Gösteriş Dansı 7", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans8"] = {"divined@dancesv2@new", "divdance8", "Gösteriş Dansı 8", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans9"] = {"divined@dancesv2@new", "divdance9", "Gösteriş Dansı 9", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans10"] = {"divined@dancesv2@new", "divdance10", "Gösteriş Dansı 10", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans11"] = {"divined@dancesv2@new", "divdance11", "Gösteriş Dansı 11", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans12"] = {"divined@dancesv2@new", "divdance12", "Gösteriş Dansı 12", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans13"] = {"divined@dancesv2@new", "divdance13", "Gösteriş Dansı 13", AnimationOptions =
    {
       EmoteLoop = true
    }},
    ["gdans14"] = {"divined@dancesv2@new", "divdance14", "Gösteriş Dansı 14", AnimationOptions =
    {
       EmoteLoop = true
    }},
    --- Fortnite Dansları ---
    ["downward_fortnite"] = {"custom@downward_fortnite", "Downward_fortnite", "Downward (Fortnite)", AnimationOptions =
    {
       EmoteMoving = false,
       EmoteLoop = true,
    }}, 
    ...
    ["macarena"] = {"custom@makarena", "makarena", "Macarena (Fortnite)", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["maraschino"] = {"custom@maraschino", "maraschino", "Maraschino (Fortnite)", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["salsa2"] = {"custom@salsa", "salsa", "Salsa 2", AnimationOptions =
    {
       EmoteLoop = true,
    }}, 
    ...
    ["wanna_see_me"] = {"custom@wanna_see_me", "wanna_see_me", "Wanna see me (Fortnite)", AnimationOptions =
    {
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ...
    ["dalgadansı"] = { -- Custom Emote By BoringNeptune
    ...
    ["dalgadansı02"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "wave_dance_2",
        "Dalga Dansı 2",
        AnimationOptions = {
    ...
    ["dalgadansı03"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "wave_dance_3",
        "Dalga Dansı 3",
        AnimationOptions = {
    ...
    ["dalgadansı04"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "wave_dance_4",
        "Dalga Dansı 4",
        AnimationOptions = {
    ...
    ["dalgadansı05"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "tutankhamun_dance_1",
        "Dalga Dansı 5",
        AnimationOptions = {
    ...
    ["dalgadansı06"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "tutankhamun_dance_2",
        "Dalga Dansı 6",
        AnimationOptions = {
    ...
    ["dalgadansı07"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "snake_dance_1",
        "Dalga Dansı 7",
        AnimationOptions = {
    ...
    ["dalgadansı08"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "slide_dance",
        "Dalga Dansı 8",
        AnimationOptions = {
    ...
    ["dalgadansı09"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "slide_dance_2",
        "Dalga Dansı 9",
        AnimationOptions = {
    ...
    ["dalgadansı10"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "robot_dance",
        "Dalga Dansı 10",
        AnimationOptions = {
    ...
    ["dalgadansı11"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "locking_dance",
        "Dalga Dansı 11",
        AnimationOptions = {
    ...
    ["dalgadansı12"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "headspin",
        "Dalga Dansı 12",
        AnimationOptions = {
    ...
    ["dalgadansı13"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "flaire_dance",
        "Dalga Dansı 13",
        AnimationOptions = {
    ...
    ["dalgadansı14"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "crowd_girl_dance",
        "Dalga Dansı 14",
        AnimationOptions = {
    ...
    ["dalgadansı15"] = { -- Custom Emote By BoringNeptune
        "dancing_wave_part_one@anim",
        "uprock_dance_1",
        "Dalga Dansı 15",
        AnimationOptions = {
	...
	["dansthriller"] = { -- Custom Emote By BoringNeptune
        "mj_thriller",
        "mj_thriller_dance",
    ...
    ["solun"] = {"divined@drillb2@new", "sturdy", "Sağlam Olun", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["solun2"] = {"divined@drillb2@new", "sturdyground", "Sağlam Olun 2", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["adımadımyürü"] = {"divined@drillb2@new", "walknstep", "Adım Adım Yürü", AnimationOptions =
    {
        EmoteLoop = true
    }},

    ["rttt"] = {"divined@drillb2@new", "toomanyglockies", "Fazla Glock Yapma", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["ogg"] = {"divined@drillb2@new", "hitemwithdat", "Onlara Gücünü Göster", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["bbgs"] = {"divined@drillb2@new", "slutmeout", "Beni Beşik Gibi Salla", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["kkaydıra"] = {"divined@drillb2@new", "toosieslide", "Kız Kaydırağı", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ["rtut"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@ds@base", "idle_a_fp", "Ritim Tut", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut2"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@rds@base", "idle_b", "Ritim Tut 2", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut3"] = {"amb@code_human_in_car_mp_actions@dance@std@ds@base", "idle_a", "Ritim Tut 3", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut4"] = {"anim@amb@nightclub@dancers@club_ambientpeds@med-hi_intensity", "mi-hi_amb_club_10_v1_male^6", "Ritim Tut 4", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut5"] = {"anim@amb@nightclub@dancers@crowddance_facedj@low_intesnsity", "li_dance_facedj_09_v1_male^6", "Ritim Tut 5", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut6"] = {"special_ped@mountain_dancer@monologue_2@monologue_2a", "mnt_dnc_angel", "Ritim Tut 6", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut7"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_hi_intensity", "trans_dance_facedj_hi_to_li_09_v1_male^6", "Ritim Tut 7", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut8"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_low_intensity", "trans_dance_facedj_li_to_hi_07_v1_male^6", "Ritim Tut 8", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut9"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_13_v2_male^6", "Ritim Tut 9", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut10"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_hi_intensity", "trans_dance_crowd_hi_to_li__07_v1_male^6", "Ritim Tut 10", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut11"] = {"anim@amb@nightclub@dancers@crowddance_single_props@hi_intensity", "hi_dance_prop_13_v1_male^6", "Ritim Tut 11", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut12"] = {"anim@amb@nightclub@dancers@crowddance_single_props_transitions@from_med_intensity", "trans_crowd_prop_mi_to_li_11_v1_male^6", "Ritim Tut 12", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut13"] = {"anim@amb@nightclub@dancers@crowddance_groups@low_intensity", "li_dance_crowd_17_v1_male^6", "Ritim Tut 13", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut14"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_med_intensity", "trans_dance_facedj_mi_to_li_09_v1_male^6", "Ritim Tut 14", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut15"] = {"timetable@tracy@ig_5@idle_b", "idle_e", "Ritim Tut 15", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut16"] = {"special_ped@mountain_dancer@monologue_1@monologue_1a", "mtn_dnc_if_you_want_to_get_to_heaven", "Ritim Tut 16", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut17"] = {"special_ped@mountain_dancer@monologue_4@monologue_4a", "mnt_dnc_verse", "Ritim Tut 17", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut18"] = {"anim@amb@nightclub@dancers@crowddance_single_props@", "hi_dance_prop_09_v1_male^6", "Ritim Tut 18", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut19"] = {"anim@amb@nightclub@dancers@dixon_entourage@", "mi_dance_facedj_15_v1_male^4", "Ritim Tut 19", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut20"] = {"anim@amb@nightclub@dancers@tale_of_us_entourage@", "mi_dance_prop_13_v2_male^4", "Ritim Tut 20", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut21"] = {"anim@mp_player_intcelebrationfemale@uncle_disco", "uncle_disco", "Ritim Tut 21", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut22"] = {"anim@mp_player_intcelebrationfemale@raise_the_roof", "raise_the_roof", "Ritim Tut 22", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut23"] = {"anim@mp_player_intcelebrationmale@cats_cradle", "cats_cradle", "Ritim Tut 23", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut24"] = {"anim@mp_player_intupperbanging_tunes", "idle_a", "Ritim Tut 24", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},

    ["rtut25"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^6", "Ritim Tut 25", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut26"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_hi_intensity", "trans_dance_facedj_hi_to_li_07_v1_female^6", "Ritim Tut 26", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut27"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^6", "Ritim Tut 27", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut28"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_06_base_laz", "Ritim Tut 28", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut29"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@ds@base", "idle_a_fp", "Ritim Tut 29", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut30"] = {"amb@code_human_in_car_mp_actions@dance@bodhi@rds@base", "idle_b", "Ritim Tut 30", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut31"] = {"anim@mp_player_intincardancebodhi@ds@", "idle_a_fp", "Ritim Tut 31", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut32"] = {"anim@mp_player_intincardancebodhi@rds@", "idle_a", "Ritim Tut 32", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut33"] = {"anim@mp_player_intincardancebodhi@rps@", "idle_c", "Ritim Tut 33", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut34"] = {"anim@mp_player_intincardancebodhi@ps@", "idle_a_fp", "Ritim Tut 34", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["rtut35"] = {"special_ped@mountain_dancer@base", "base", "Ritim Tut 35", AnimationOption =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
...
RP.AnimalEmotes = {
    ...
    ["poz309"] = {"perlenfuchs@male_gun", "male_gun_clip", "Özel Poz 309", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["poz310"] = {"perlenfuchs@male_fxckyou", "male_fxckyou_clip", "Özel Poz 310", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["poz311"] = {"perlenfuchs@lamp", "lamp_clip", "Özel Poz 311", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["poz312"] = {"perlenfuchs@fxckyou", "fxckyou_clip", "Özel Poz 312", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ...
    ["poz327"] = {"custom@fsign_1", "fsign_1", "Özel Poz 327", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ...
    ["poz385"] = {"perlenfuchs@ballerina_1", "ballerina_1_clip", "Özel Poz 385", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
...
RP.Emotes = {
    ...
    ["çeteduruşu3"] = {"custom@gsign_03", "gsign_03", "Çete Duruşu 3", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu4"] = {"custom@gsign_04", "gsign_04", "Çete Duruşu 4", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu5"] = {"custom@gsign_05", "gsign_05", "Çete Duruşu 5", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu6"] = {"custom@gsign_06", "gsign_06", "Çete Duruşu 6", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu7"] = {"custom@gsign_07", "gsign_07", "Çete Duruşu 7", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu8"] = {"custom@gsign_08", "gsign_08", "Çete Duruşu 8", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu9"] = {"custom@gsign_09", "gsign_09", "Çete Duruşu 9", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu10"] = {"custom@gsign_10", "gsign_10", "Çete Duruşu 10", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu11"] = {"custom@gsign_11", "gsign_11", "Çete Duruşu 11", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu12"] = {"custom@gsign_12", "gsign_12", "Çete Duruşu 12", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu13"] = {"custom@gsign_13", "gsign_13", "Çete Duruşu 13", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu14"] = {"custom@gsign_14", "gsign_14", "Çete Duruşu 14", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu15"] = {"custom@mgsign_01", "mgsign_01", "Çete Duruşu 15", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu16"] = {"custom@mgsign_02", "mgsign_02", "Çete Duruşu 16", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu17"] = {"custom@mgsign_03", "mgsign_03", "Çete Duruşu 17", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu18"] = {"custom@mgsign_04", "mgsign_04", "Çete Duruşu 18", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu19"] = {"custom@gsign_26", "gsign_26", "Çete Duruşu 19", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["çeteduruşu20"] = {"custom@gsign_27", "gsign_27", "Çete Duruşu 20", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["çeteduruşu21"] = {"custom@gsign_28", "gsign_28", "Çete Duruşu 21", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["çeteduruşu22"] = {"custom@gsign_29", "gsign_29", "Çete Duruşu 22", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu23"] = {"custom@gsign_30", "gsign_30", "Çete Duruşu 23", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = false,
    }},
    ["çeteduruşu24"] = {"custom@gsign_31", "gsign_31", "Çete Duruşu 24", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu25"] = {"custom@gsign_32", "gsign_32", "Çete Duruşu 25", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu26"] = {"custom@gsign_33", "gsign_33", "Çete Duruşu 26", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu27"] = {"custom@gsign_34", "gsign_34", "Çete Duruşu 27", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu28"] = {"custom@gsign_35", "gsign_35", "Çete Duruşu 28", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu29"] = {"custom@gsign_36", "gsign_36", "Çete Duruşu 29", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu30"] = {"custom@gsign_37", "gsign_37", "Çete Duruşu 30", AnimationOptions =
    {
       EmoteLoop = true,
       EmoteMoving = true,
    }},
    ["çeteduruşu31"] = {"custom@gsign_01", "gsign_01", "Çete Duruşu 31", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
    ["çeteduruşu32"] = {"custom@gsign_02", "gsign_02", "Çete Duruşu 32", AnimationOptions =
    {
      EmoteLoop = true,
      EmoteMoving = false,
    }},
	...
	["sekspoz"] = { -- Custom emote by Struggleville
...
RP.PropEmotes = {
    ["dgpasta"] = {"anim@heists@box_carry@", "idle", "Doğum Günü Pastası 1", AnimationOptions =
    {
    ...
    ["dgpasta2"] = { "anim@move_f@waitress", "idle", "Doğum Günü Pastası 2", AnimationOptions = 
    {
        Prop = "bzzz_prop_cake_birthday_001",
        PropBone = 28422,
    ...
    ["salataye"] = {
        ...
        AnimationOptions = {
            Prop = 'alcaprop_fork',
            PropBone = 57005,
            PropPlacement = {0.14, 0.02, 0.01, -118.0, 192.0, 24.0},
            EmoteMoving = true,
            EmoteLoop = true
        }
    },
