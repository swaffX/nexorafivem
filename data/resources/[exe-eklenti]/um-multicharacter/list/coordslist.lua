...
--[[
    ...
    i.e. an apartment or a garage or a house, as interiors are not supported in cr-multicharacter
...
Coords.List = {
    ...
    [5] = { pedCoords = vector4(1978.67, 3830.5, 32.52, 227.04), camCoords = vector4(1981.2941, 3827.7786, 32.4587, 43.2443) },
