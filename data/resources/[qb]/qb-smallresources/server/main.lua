...
QBCore.Commands.Add("nakit", "Üzerindeki nakit miktarını göster", {}, false, function(source)
    local Player = QBCore.Functions.GetPlayer(source)
    local cash = Player.Functions.GetMoney("cash")
    TriggerClientEvent('QBCore:Notify', source, "Üzerindeki nakit: $" .. cash, "primary", 5000)
end)

QBCore.Commands.Add("banka", "Bankadaki paranı göster", {}, false, function(source)
    local Player = QBCore.Functions.GetPlayer(source)
    local bank = Player.Functions.GetMoney("bank")
    TriggerClientEvent('QBCore:Notify', source, "Bankadaki paran: $" .. bank, "primary", 5000)
end)
