...
if Config.EnablePedMenu then
    QBCore.Commands.Add('pedmenu', 'Ped menü verir', {{
        name = 'id',
        ...
        if playerId then
            ...
            if Player then
                ...
                TriggerClientEvent('QBCore:Notify', src, "Oyuncu aktif değil", 'error')
                return
            end
        end
...
QBCore.Commands.Add('yenile', 'Karakteri yeniler', {}, false, function(source, _)
