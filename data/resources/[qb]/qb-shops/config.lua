...
Config.Products = {
    ...
    ['hardware'] = {
        {name = 'lockpick',          price = 7000, amount = 50,  info = {}, type = 'item'},
    ...
    ['weapons'] = {
        {name = '',         price = 100000000,  amount = 250, info = {}, type = 'weapon'},
        {name = '',           price = 100000000,  amount = 250, info = {}, type = 'weapon'},
        {name = '',       price = 250,  amount = 250, info = {}, type = 'weapon'},
        {name = '',          price = 250,  amount = 250, info = {}, type = 'item',   requiredLicense = { 'weapon' }},
        {name = '',        price = 2500, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
        {name = '',     price = 1500, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
        {name = '', price = 4000, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
    },
    ['casino'] = {
