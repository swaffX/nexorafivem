...
Config.sql = "ghmattimysql" -- dont forget to change fxmanifest.lua! |ghmattimysql - oxmysql - mysql-async
...
Config.Language = {
    ...
    ["catchFish"] = "Balığı yakaladın!",
    ["youCantFishHere"] = "Burada balık tutamazsın!",
    ["somethingStoppingFish"] = "Something's stopping you from fishing",
    ["movementOnRod"] = "Oltanda bir hareketlilik bulunuyor!",
    ["missedFish"] = "Balığı kaçırdın.",
    ["noLeftBait"] = "No bait left at the end of the fishing rod!",
    ["fishingHBStopped"] = "Balıkçılık işlemi durduruldu.",
    ["illegalCant"] = "Bu bölgede illegal balıkçılık yapamazsın!",
...
Config.Tasks = { -- TASKS APPEARING ON THE FISH MENU
    ...
    },
    {
        ...
        taskName = "Catch 20 Shark", -- NAME OF THE TASK AS IT APPEARS IN THE MENU
...
Config.Fishes = { -- /FISH MENU SETTINGS
    {
        ...
        description = "You can catch this fish on the pier, you need a fishing rod of level 1 or higher to catch the fish!"
    },
    {
...
Config.sellMenuItems = { -- FISH ON THE FISH SALE MENU
    {
        ...
        fishPrice = 40, -- SALE PRICE OF FISH
    ...
    },
    {
        ...
        fishName = "Anchovy", -- THE APPARENT NAME OF THE FISH
        itemName = "anchovy", -- ITEM NAME OF THE FISH
        fishPrice = 60, -- SALE PRICE OF FISH
    ...
    },
    {
        ...
        fishName = "Small Bluefish", -- THE APPARENT NAME OF THE FISH
        itemName = "smallbluefish", -- ITEM NAME OF THE FISH
        fishPrice = 80, -- SALE PRICE OF FISH
    ...
    },
    {
        ...
        fishName = "Garfish", -- THE APPARENT NAME OF THE FISH
        itemName = "garfish", -- ITEM NAME OF THE FISH
        fishPrice = 140, -- SALE PRICE OF FISH
