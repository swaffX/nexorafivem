...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Animasyon Oynat', {{ name="emotename", help="dance, camera, sit veya herhangi bir animasyon oynat."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Animasyon Oynat', {{ name="emotename", help="dance, camera, sit veya herhangi bir animasyon oynat."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Animasyon Oynat', {{ name="emotename", help="dance, camera, sit veya herhangi bir animasyon oynat."}})
...
RegisterCommand('animasyon', function(source, args, raw) OpenEmoteMenu() end)
